...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		$sql_insert="insert into feedback_master (roll_no, b_id, batch_id, feedback_no, sem_id, f_id, sub_id, division_id, ans1, ans2, ans3, ans4, ans5, ans6, ans7, ans8, ans9,ans10,ans11,ans12,ans13,ans14,ans15,ans16, remark, feed_date) values ('".$_POST['roll_no']."','".$_POST['b_name']."','".$_POST['batch_name']."','".$result['feedback_no']."','".$_POST['sem_name']."','".$_POST['fac_name']."','".$_POST['sub_name']."', '".$_POST['division']."', '".$_POST['ans_1']."','".$_POST['ans_2']."','".$_POST['ans_3']."','".$_POST['ans_4']."','".$_POST['ans_5']."','".$_POST['ans_6']."','".$_POST['ans_7']."','".$_POST['ans_8']."','".$_POST['ans_9']."','".$_POST['ans_10']."','".$_POST['ans_11']."','".$_POST['ans_12']."','".$_POST['ans_13']."','".$_POST['ans_14']."','".$_POST['ans_15']."','".$_POST['ans_16']."','".$_POST['remark']."','".date('Y-m-d')."')";//,strtotime($_POST['date'])
