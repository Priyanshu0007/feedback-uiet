...
if(isset($_POST['submit']))
  {//begin of if($submit).
	...
	else
	{
         ...
         //Add a row to table member
        $res = mysql_query("INSERT INTO members (username,password) VALUES ('".$f_name."_".$l_name."',password('$passwd')) ");
        //TODO: Get memid of member row that we just created
        $query = "SELECT id from members WHERE username = '".$f_name."_".$l_name."'";
        //echo "QUERY:".$query;
        $res = mysql_query($query);
        $memid = mysql_result($res, 0);
        $query = "INSERT INTO faculty_master (f_name,l_name,b_id,mem_id) VALUES ('$f_name','$l_name','$b_id','$memid')";
